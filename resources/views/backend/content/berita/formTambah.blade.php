        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form action="{{route('berita.prosesTambah')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Kategori Beritai</label>
                        <select name="id_kategori" class="form-control @error('judul_berita') is-invalid @enderror">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Foto Beritai</label>
                        ...
                        @enderror
                        <p></p>
                        <img id="tampilFoto" src="" onerror="this.onerror=null;this.src='https://t4.ftcdn.net/jpg/04/73/25/49/360_F_473254957_bxG9yf4ly70B051005KABLN930GwaMQz.jpg';" alt="" width="15%">
                    </div>
