            ...
            <div class="card-body">
                <form action="{{route('berita.prosesUbah')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <p></p>
                        <img id="tampilFoto" src="" onerror="this.onerror=null;this.src='https://t4.ftcdn.net/jpg/04/73/25/49/360_F_473254957_bxG9yf4ly70B051005KABLN930GwaMQz.jpg';" src="{{route('storage',$berita->gambar_berita)}}" alt="" width="15%">
                    </div>
