...
class UserController extends Controller
{
    ...
    public function prosesTambah(Request $request){
        ...
        try{
            ...
            return redirect(route('user.index'))->with('pesan',['denger','Gagal tambah user']);
    ...
    public function prosesUbah(Request $request){
        ...
        try{
            ...
            return redirect(route('user.index'))->with('pesan',['denger','Gagal Ubah user']);
    ...
    public function hapus($id){
        ...
        try{
            ...
            return redirect(route('user.index'))->with('pesan',['denger','Gagal Hapus user']);
